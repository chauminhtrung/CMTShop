...
public class PDFGenerator {
	public static Document generateDoanhThuToPDF(JTable tblThongKe, FileOutputStream outFile)
		...
		BaseFont baseFont = BaseFont.createFont("src\\Roboto\\Roboto-Black.ttf", BaseFont.IDENTITY_H,
				BaseFont.EMBEDDED);
		...
		BaseFont baseFontCell = BaseFont.createFont("src\\Roboto\\Roboto-Light.ttf", BaseFont.IDENTITY_H,
				BaseFont.EMBEDDED);
