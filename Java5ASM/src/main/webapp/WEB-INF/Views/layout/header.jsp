...
<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-12 text-center text-md-start">
						<span><s:message code="header.si" /></span>
					</div>
					<div class="col-6 text-end d-none d-md-block">
						<div class="dropdown selectBox">
							<a class="dropdown-toggle selectValue text-reset"
								href="javascript:void(0)" data-bs-toggle="dropdown"
								aria-expanded="false"> <span class="me-2"> </span> Language
							</a>

							<ul class="dropdown-menu">
								<li><a class="dropdown-item" href="?lang=en"> <c:set
											var="langue" scope="session" value="0" /> English
								</a></li>
								<li><a class="dropdown-item" href="?lang=vi"> Viet Nam
								</a></li>
							</ul>
			...
			<div class="container">
				<div class="row w-100 align-items-center gx-lg-2 gx-0">
					<div class="col-xxl-2 col-lg-3 col-md-6 col-5">
						<a class="navbar-brand d-none d-lg-block fs-3 text-success"
							href="/"> CMTShopCart </a>
						<div class="d-flex justify-content-between w-100 d-lg-none">
							<a class="navbar-brand" href="/"> CMTShopCart </a>
						</div>
					</div>
						...
						<form action="#">
							<div class="input-group">
								<input class="form-control rounded" type="search"
									placeholder="<s:message code="header.placeInput"/>"> <span
					...
					<div class="col-md-2 col-xxl-3 d-none d-lg-block">
						...
						<button type="button" class="btn btn-outline-gray-400 text-muted"
							...
							<s:message code="header.btnLo" />
						</button>
					</div>
					<div class="col-lg-2 col-xxl-2 text-end col-md-6 col-7">
						<div class="list-inline">
							<div class="list-inline-item me-5">
								<a href="/product/wishlist" class="text-muted position-relative">
								...
								</svg> <!-- so luong wishlist   --> <span
									class="position-absolute visually-hidden top-0 start-100 translate-middle badge rounded-pill bg-success">
							...
							<div class="list-inline-item me-5">
								...
								<c:if test="${not empty user}">
									...
									<circle cx="12" cy="7" r="4"></circle>
										...
										<ul class="dropdown-menu">
											<li><a class="dropdown-item text-success" href="#">${user.fullname}</a></li>
											<li><a class="dropdown-item"
												href="./pages/forgot-password.html">Change Password</a></li>
											<li class="dropdown-submenu dropend"><a
												class="dropdown-item dropdown-list-group-item dropdown-toggle"
												href="#">My Account</a>
												<ul class="dropdown-menu">
												
														<li><a class="dropdown-item" href="/Manager/index">Manager</a></li>
							...
							<div class="list-inline-item me-5 me-lg-0">
								...
								</svg> <!-- so luong don hang   --> <span
									class="position-absolute top-0 start-100 visually-hidden translate-middle badge rounded-pill bg-success">
										<span class="visually-hidden">unread messages</span>
								</span>
								</a>
							</div>
			...
			<div class="container">
				<div class="offcanvas offcanvas-start" tabindex="-1"
					...
					<div class="offcanvas-header pb-1">
						<a href="#" class="fs-3 text-success">CMTShopCart</a>
					...
					<div class="offcanvas-body">
						...
						<div class="d-block d-lg-none mb-4">
							...
							</span> <s:message code="header.btnDepa" />
							</a>
							<div class="collapse mt-2" id="collapseExample">
								<div class="card card-body">
									<ul class="mb-0 list-unstyled">
										...
										<li><a class="dropdown-item"
											href="./pages/shop-grid.html">Breakfast &amp; Instant
												Food</a></li>
										<li><a class="dropdown-item"
							...
							<ul class="navbar-nav align-items-center">
								<li class="nav-item dropdown w-100 w-lg-auto"><a
									...
									data-bs-toggle="dropdown" aria-expanded="false"><s:message
											code="header.home" /></a>
									<ul class="dropdown-menu">
										<li><a class="dropdown-item" href="./index.html"><s:message
													code="header.home" /> 1</a></li>
										<li><a class="dropdown-item" href="./pages/index-2.html">Home
												2</a></li>
										<li><a class="dropdown-item" href="./pages/index-3.html">Home
												3</a></li>
										<li><a class="dropdown-item" href="./pages/index-4.html">Home
												4</a></li>
										<li><a class="dropdown-item" href="./pages/index-5.html">Home
												5</a></li>
									</ul></li>
								<li class="nav-item dropdown w-100 w-lg-auto"><a
									class="nav-link dropdown-toggle" href="#" role="button"
									...
									<ul class="dropdown-menu">
										<li><a class="dropdown-item"
											href="./pages/shop-grid.html">Shop Grid - Filter</a></li>
										<li><a class="dropdown-item"
											href="./pages/shop-grid-3-column.html">Shop Grid - 3
												column</a></li>
										<li><a class="dropdown-item"
											href="./pages/shop-list.html">Shop List - Filter</a></li>
										<li><a class="dropdown-item"
											href="./pages/shop-filter.html">Shop - Filter</a></li>
										<li><a class="dropdown-item"
											href="./pages/shop-fullwidth.html">Shop Wide</a></li>
										<li><a class="dropdown-item"
											href="./pages/shop-single.html">Shop Single</a></li>
										<li><a class="dropdown-item"
											href="./pages/shop-single-2.html">Shop Single v2</a></li>
										<li><a class="dropdown-item"
											href="./pages/shop-wishlist.html">Shop Wishlist</a></li>
										<li><a class="dropdown-item"
											href="./pages/shop-cart.html">Shop Cart</a></li>
										<li><a class="dropdown-item"
								...
								<li class="nav-item dropdown w-100 w-lg-auto"><a
									class="nav-link dropdown-toggle" href="#" role="button"
									data-bs-toggle="dropdown" aria-expanded="false"><s:message
											code="header.stores" /></a>
									<ul class="dropdown-menu">
										<li><a class="dropdown-item"
											href="./pages/store-list.html">Store List</a></li>
										<li><a class="dropdown-item"
											href="./pages/store-grid.html">Store Grid</a></li>
										<li><a class="dropdown-item"
											href="./pages/store-single.html">Store Single</a></li>
									</ul></li>
								<li class="nav-item dropdown w-100 w-lg-auto dropdown-fullwidth">
									<a class="nav-link dropdown-toggle" href="#" role="button"
									data-bs-toggle="dropdown" aria-expanded="false"><s:message
											code="header.megamenu" /></a>
									<div class="dropdown-menu pb-0">
										<div class="row p-2 p-lg-4">
											<div class="col-lg-3 col-12 mb-4 mb-lg-0">
												<h6 class="text-primary ps-3">Dairy, Bread &amp; Eggs</h6>
												<a class="dropdown-item" href="./pages/shop-grid.html">Butter</a>
												<a class="dropdown-item" href="./pages/shop-grid.html">Milk
													Drinks</a> <a class="dropdown-item"
													href="./pages/shop-grid.html">Curd &amp; Yogurt</a> <a
													class="dropdown-item" href="./pages/shop-grid.html">Eggs</a>
												<a class="dropdown-item" href="./pages/shop-grid.html">Buns
													&amp; Bakery</a> <a class="dropdown-item"
													href="./pages/shop-grid.html">Cheese</a> <a
													class="dropdown-item" href="./pages/shop-grid.html">Condensed
													Milk</a> <a class="dropdown-item" href="./pages/shop-grid.html">Dairy
													Products</a>
											</div>
											<div class="col-lg-3 col-12 mb-4 mb-lg-0">
												<h6 class="text-primary ps-3">Breakfast &amp; Instant
													Food</h6>
												<a class="dropdown-item" href="./pages/shop-grid.html">Breakfast
													Cereal</a> <a class="dropdown-item"
													href="./pages/shop-grid.html">Noodles, Pasta &amp; Soup</a>
												<a class="dropdown-item" href="./pages/shop-grid.html">Frozen
													Veg Snacks</a> <a class="dropdown-item"
													href="./pages/shop-grid.html">Frozen Non-Veg Snacks</a> <a
													class="dropdown-item" href="./pages/shop-grid.html">Vermicelli</a>
												<a class="dropdown-item" href="./pages/shop-grid.html">Instant
													Mixes</a> <a class="dropdown-item"
													href="./pages/shop-grid.html">Batter</a> <a
													class="dropdown-item" href="./pages/shop-grid.html">Fruit
													and Juices</a>
											</div>
											<div class="col-lg-3 col-12 mb-4 mb-lg-0">
												...
												<a class="dropdown-item" href="./pages/shop-grid.html">Soft
													Drinks</a> <a class="dropdown-item"
													href="./pages/shop-grid.html">Fruit Juices</a> <a
													class="dropdown-item" href="./pages/shop-grid.html">Coldpress</a>
												<a class="dropdown-item" href="./pages/shop-grid.html">Water
													&amp; Ice Cubes</a> <a class="dropdown-item"
													href="./pages/shop-grid.html">Soda &amp; Mixers</a> <a
													class="dropdown-item" href="./pages/shop-grid.html">Health
													Drinks</a> <a class="dropdown-item"
													href="./pages/shop-grid.html">Herbal Drinks</a> <a
													class="dropdown-item" href="./pages/shop-grid.html">Milk
													Drinks</a>
											</div>
											<div class="col-lg-3 col-12 mb-4 mb-lg-0">
								...
								<li class="nav-item dropdown w-100 w-lg-auto"><a
									...
									<ul class="dropdown-menu">
										...
										<li><a class="dropdown-item"
											href="./pages/blog-single.html">Blog Single</a></li>
										<li><a class="dropdown-item"
									...
									<ul class="dropdown-menu">
										...
										<li class="dropdown-submenu dropend"><a
											...
											<ul class="dropdown-menu">
												...
												<li><a class="dropdown-item"
													href="./pages/account-payment-method.html">Payment
														Method</a></li>
												<li><a class="dropdown-item"
								...
								<li class="nav-item w-100 w-lg-auto"><a class="nav-link"
									href="./dashboard/index.html"><s:message
											code="header.dashboard" /></a></li>
								<li class="nav-item dropdown w-100 w-lg-auto dropdown-flyout">
									<a class="nav-link" href="#" id="navbarDropdownDocs"
									role="button" data-bs-toggle="dropdown" aria-haspopup="true"
									aria-expanded="false"><s:message code="header.docs" /></a>
									<div class="dropdown-menu dropdown-menu-lg"
										...
										<a class="dropdown-item align-items-start"
										...
										</a> <a class="dropdown-item align-items-start"
											...
											<div>
												...
												<path
														d="M8.235 1.559a.5.5 0 0 0-.47 0l-7.5 4a.5.5 0 0 0 0 .882L3.188 8 .264 9.559a.5.5 0 0 0 0 .882l7.5 4a.5.5 0 0 0 .47 0l7.5-4a.5.5 0 0 0 0-.882L12.813 8l2.922-1.559a.5.5 0 0 0 0-.882l-7.5-4zm3.515 7.008L14.438 10 8 13.433 1.562 10 4.25 8.567l3.515 1.874a.5.5 0 0 0 .47 0l3.515-1.874zM8 9.433 1.562 6 8 2.567 14.438 6 8 9.433z"></path>
											</svg>
											</div>
											<div class="ms-3 lh-1">
												<h6 class="mb-1">
	...
	<!-- modal location navbar  -->
	<div class="modal fade" id="locationModal" tabindex="-1"
		aria-labelledby="locationModalLabel" style="display: none;"
		aria-hidden="true">
		<div class="modal-dialog modal-sm modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-body p-6">
					...
					<div>
						<div data-simplebar="init" style="height: 300px" class="">
							...
							<div class="simplebar-track simplebar-vertical"
								style="visibility: hidden;">
								<div class="simplebar-scrollbar"
									style="height: 0px; display: none; transform: translate3d(0px, 109px, 0px);"></div>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="modal fade" id="userModal" tabindex="-1"
		aria-labelledby="userModalLabel" style="display: none;"
		aria-hidden="true">
			...
			<div class="modal-content p-4">
				...
				<div class="modal-body">
					...
					<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
						...
						<li class="nav-item" role="">
							<button class="nav-link" id="pills-forgotpass-tab"
								data-bs-toggle="pill" data-bs-target="#pills-forgotpass"
								type="button" role="tab" aria-controls="pills-forgotpass"
								aria-selected="false">Forgot Password</button>
						</li>
					</ul>
					<div class="tab-content" id="pills-tabContent">
							...
							<form action="/regis" method="post" enctype="multipart/form-data"
								...
								<div class="mb-3">
									...
									<small class="form-text"> By Signup, you agree to our <a
										href="#!">Terms of Service</a> &amp; <a href="#!">Privacy
											Policy</a>
									</small>
								</div>
						...
						<!--  forgot pass -->
						<div class="tab-pane fade" id="pills-forgotpass" role="tabpanel"
							aria-labelledby="pills-forgotpass-tab">
										...
										<form action="/resetpass" method="post">
											<div class="form-group">
												<label for="exampleInputEmail1">Enter your email
													address and we will send you a link to reset your password.</label>
												<input type="email" name="email" class="form-control  mt-2"
													placeholder="Enter your email address" required>
											</div>

											<button type="submit" class="btn btn-primary btn-block mt-3">Send
	...
	<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
		...
		<div class="offcanvas-body">
			<div>
				<form action="/student/save" modelAttribute="prod">
					<!-- alert -->
					<div class="alert alert-danger p-2" role="alert">
								...
								<div class="row align-items-center">
									...
									<div class="col-4 col-md-3 col-lg-3">
										...
										<div class="input-group input-spinner">
											...
											<input type="number" step="1" max="10" value="${product.qty}"
												name="quantity"
					...
					<div class="d-flex justify-content-between mt-4">
						<a href="/buynow" class="btn btn-primary">Buy Now</a> <a
							href="/updatecart" class="btn btn-dark">Update Cart</a>
					</div>
				</form>
			</div>
		</div>
